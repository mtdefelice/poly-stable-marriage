...
A flexible, polygamous stable marriage implementation in Python. Based on the [Gale–Shapley algorithm](https://en.wikipedia.org/wiki/Stable_marriage_problem).
